...
| **频域滤波 (FFT)** | 网格状/规律排列的半透明水印，基于傅里叶变换
...
### 频域滤波 (FFT)
通过傅里叶变换将图像转换到频域，利用**径向谐波聚类检测**定位周期性水印的异常频率峰值并抑制，再逆变换还原图像。对网格状/规律排列的半透明水印效果极佳，对不规则水印无效。
